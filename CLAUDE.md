...
| Auto-Branding 상단 배너 | 본문 폭과 맞춘 반응형 HTML 배너 + 헤더 CTA, `auto-branding.com` sponsor 링크 | `public/index.html` |
...
- [ ] Auto-Branding 배너 수정 시 헤더 CTA와 상단 배너 링크가 모두 `https://auto-branding.com/`인지 확인하고, 모바일에서 문구가 헤더를 밀어내지 않게 유지
